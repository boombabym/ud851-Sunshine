...
//  TODO (20) Create a constant int to identify our loader used in DetailActivity
    private static final int ID_DETAIL_LOADER = 445;
...
//      TODO (27) Display the weather description (using SunshineWeatherUtils)
        ...
        String weatherDesc = SunshineWeatherUtils.getStringForWeatherCondition(this, weatherID);
        mDescription.setText(weatherDesc);

//      TODO (28) Display the high temperature
        double highTemp = data.getDouble(INDEX_WEATHER_MAX_TEMP);
        String formattedHighTemp = SunshineWeatherUtils.formatTemperature(this, highTemp);
        mHighTemp.setText(formattedHighTemp);

//      TODO (29) Display the low temperature
        double lowTemp = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String formattedLowTemp = SunshineWeatherUtils.formatTemperature(this, lowTemp);
        mLowTemp.setText(formattedLowTemp);

//      TODO (30) Display the humidity
        float humidity = data.getFloat(INDEX_WEATHER_HUMIDITY);
        String formattedHumidity = "{humidity} %%";
...
//      TODO (31) Display the wind speed and direction
        ...
        String formattedWindSpeed = SunshineWeatherUtils.getFormattedWind(this, windSpeed, windDegrees);
        mWind.setText(formattedWindSpeed);

//      TODO (32) Display the pressure
        float pressure = data.getFloat(INDEX_WEATHER_PRESSURE);
        String formattedPressure = "{pressure} hPa";
        mPressure.setText(formattedPressure);

//      TODO (33) Store a forecast summary in mForecastSummary
        mForecastSummary = String.format("%s - %s - %s/%s",
                dateText, weatherDesc, formattedHighTemp, formattedLowTemp);
    }
