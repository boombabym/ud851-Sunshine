...
//        }
    ...
    public class WeatherQueryTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            String userLoc = params[0];
            URL weatherRequestURL = NetworkUtils.buildUrl(userLoc);
            String jsonWeatherResults = null;
            String[] simpleJsonWeatherData = null;
            try{
                jsonWeatherResults = NetworkUtils.getResponseFromHttpUrl(weatherRequestURL);
                simpleJsonWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, jsonWeatherResults);
