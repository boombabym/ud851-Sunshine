...
//      TODO (7) Generate a weather summary with the date, description, high and low
        long dateInMseconds = mCursor.getLong(MainActivity.INDEX_WEATHER_DATE);
        String dateString = SunshineDateUtils.getFriendlyDateString(mContext, dateInMseconds, false);
        ...
        String weatherForThisDay = dateString + " - " + description + " - " + highAndLowTemp;
