...
//  TODO (1) Create a constant int value to identify the notification
    public static final int SUNSHINE_WEATHER_NOTIFICATION_ID = 7744;
...
//          TODO (4) Use TaskStackBuilder to create the proper PendingIntent
            TaskStackBuilder backToMainActivity = TaskStackBuilder.create(context);
            backToMainActivity.addNextIntentWithParentStack(detailIntent);
            PendingIntent backToMainIntent = backToMainActivity
                    .getPendingIntent(0, PendingIntent.FLAG_UPDATE_CURRENT);

//          TODO (5) Set the content Intent of the NotificationBuilder
            builder.setContentIntent(backToMainIntent);
...
//          TODO (7) Notify the user with the ID WEATHER_NOTIFICATION_ID
            manager.notify(SUNSHINE_WEATHER_NOTIFICATION_ID, builder.build());
